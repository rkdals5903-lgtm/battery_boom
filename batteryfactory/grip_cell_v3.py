...
INSPECTION_VIEW_OFFSET_M = np.array([0.02, 0.21, -0.05], dtype=float)
...
def main():
    ...
    if inspection_ok:
        ...
        runner.move(
            runner.tcp_to_link6(new_case_safe_transfer),
            "high transfer above new_case",
            0.12,
            follower.update,
            0.125,
        )
        runner.move(
            runner.tcp_to_link6(new_case_overhead),
            "new_case overhead",
            0.10,
            follower.update,
            0.10,
        ...
        runner.move(
            runner.tcp_to_link6(new_case_tcp),
            "new_case placement",
            0.050,
            follower.update,
            0.055,
        ...
        command_gripper(
            world, robot, controller, gripper_dof_indices,
            GRIPPER_OPEN, "final release in new_case",
        )
